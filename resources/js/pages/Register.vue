<template>
  <div class="mx-auto w-4/12 mt-10 p-4 rounded-lg relative flex flex-col justify-center min-h-screen overflow-hidden">
    <!-- component -->
    <div class="w-full p-6 m-auto bg-white border-t-4 border-purple-600 rounded-md shadow-md border-top lg:max-w-md">
      <h1 class="text-gray-600 py-5 font-bold text-3xl text-center">
        Create Account
      </h1>
      ...
      <form method="post" @submit="handleSubmit">
        ...
        <div class="mb-4">
          ...
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" type="email" id="email"
